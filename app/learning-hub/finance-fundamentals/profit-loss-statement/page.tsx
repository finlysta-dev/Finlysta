// app/learning-hub/finance-fundamentals/profit-loss-statement/page.tsx
...
export default function ProfitLossStatementPage() {
  ...
  const relatedLessonsData: RelatedLessonProps[] = [
    { title: "Balance Sheet Explained", duration: "15 min", icon: Layers, href: "/learning-hub/finance-fundamentals/balance-sheet" },
    ...
    { title: "Income Statement Analysis", duration: "20 min", icon: TrendingUp, href: "/learning-hub/financial-analysis/income-statement" },
    { title: "EBITDA Deep Dive", duration: "12 min", icon: Calculator, href: "/learning-hub/financial-analysis/ebitda" },
    ...
    <div className={`${styles.bgPrimary} min-h-screen`}>
      <div className={styles.container}>
        ...
        <div className={styles.breadcrumb}>
          ...
          <ChevronRight className="w-3 h-3" />
          <a href="/learning-hub/finance-fundamentals" className={styles.breadcrumbLink}>finance-fundamentals</a>
          <ChevronRight className="w-3 h-3" />
  ...
  Profit & Loss Statement Explained for Beginners
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className={styles.insightBox}>
                ...
                <div className="mt-3 pt-2 border-t border-[#2563EB]/20">
                  <a href="/learning-hub/financial-analysis/apple-case-study" className="text-sm text-[#2563EB] font-semibold hover:underline inline-flex items-center gap-1">
        ...
        <div className="mb-10 flex justify-between items-center flex-wrap gap-4">
          <a href="/learning-hub/finance-fundamentals/balance-sheet" className="inline-flex items-center gap-3 px-6 py-3 bg-[#111827] text-black rounded-xl font-semibold hover:bg-[#1f2937] transition-colors group">
            Continue to Balance Sheet
            <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
          </a>
          <div className="flex gap-4">
            <a href="/learning-hub/finance-fundamentals/cash-flow-statement" className="text-sm text-[#6B7280] hover:text-[#2563EB] transition-colors">Cash Flow →</a>

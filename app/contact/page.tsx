        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              ...
              <a href="mailto:support@finlysta.com" className="text-blue-600 hover:text-blue-700 font-medium inline-flex items-center">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="flex space-x-3">
                <a href="https://www.linkedin.com/company/finlysta/" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-100 rounded-lg hover:bg-blue-100 transition-colors">

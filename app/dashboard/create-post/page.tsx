...
export default function CreatePostPage() {
  ...
  const handleSubmit = async (isPublished: boolean) => {
    if (!title.trim()) {
      setError("Please provide a title for your showcase.");
      return;
    }
    ...
    try {
      // ✅ CHANGE THIS LINE - from "/api/posts" to "/api/posts/create"
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FF] pb-20">
        ...
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center gap-2 bg-blue-600 text-white px-5 py-2 rounded-xl font-bold text-sm hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all disabled:opacity-50"
            >
      ...
      <main className="max-w-3xl mx-auto mt-12 px-6">
        {error && (
          <div className="mb-6 flex items-center gap-3 bg-red-50 border border-red-100 text-red-600 p-4 rounded-2xl animate-in fade-in slide-in-from-top-2">
            <AlertCircle size={20} />
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
          <div className="mb-8">
            <span className="flex items-center gap-2 text-blue-600 text-[10px] font-black uppercase tracking-widest mb-4">
              <Sparkles size={14} /> Showcase Your Work
            </span>
            <input
          ...
          <div className="space-y-6">
            <div className="relative">
              <textarea
                className="w-full text-lg text-slate-700 placeholder:text-slate-300 outline-none border-none bg-transparent resize-none min-h-[300px]"

...
const topCompanies = [
  ...
  "Accenture", "Amazon", "Microsoft", "Google"
];

const locations = ["Mumbai", "Bengaluru", "Delhi NCR", "Pune", "Hyderabad", "Remote"];
    ...
    try {
      ...
      if (Array.isArray(data)) {
        const filtered = data.filter((job: Internship) => 
          ...
          job.category?.toLowerCase().includes("financial analyst") ||
          job.title?.toLowerCase().includes("financial analyst") ||
          job.title?.toLowerCase().includes("fp&a") ||
      ...
      <main className="bg-[#F8FAFC] min-h-screen">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <nav className="flex items-center gap-2 text-sm text-slate-400 mb-6">
            ...
            <span className="text-[#0A2540] font-medium">Financial Analyst Internships</span>
          </nav>

          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 bg-[#0A2540]/5 px-4 py-2 rounded-full mb-5">
              <span className="w-1.5 h-1.5 bg-[#10B981] rounded-full animate-pulse" />
              <span className="text-xs font-medium text-[#0A2540]">Entry Friendly</span>
            </div>
            <h1 className="text-4xl sm:text-5xl font-bold text-[#0A2540] mb-4">
              Financial Analyst Internships in India <span className="text-[#10B981]">(2026)</span>
            </h1>
            <p className="text-slate-500 max-w-2xl mx-auto">
              Verified financial analyst internships at top companies - no signup required.
            </p>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-3xl mx-auto mb-12">
            <div className="text-center">
              <div className="text-2xl font-bold text-[#0A2540]">{internships.length || 12}+</div>
          ...
          <div className="mb-12">
            <div className="text-center mb-6">
              <h2 className="text-xl font-semibold text-[#0A2540]">Latest Financial Analyst Internships</h2>
            ...
            {isLoading ? (
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-10 text-center">
                ...
                <p className="text-slate-500">No financial analyst internships available right now.</p>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 mb-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-semibold text-[#0A2540]">Top Companies Hiring Financial Analyst Interns</h2>
            </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 mb-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-sm font-semibold text-[#0A2540] mb-1">What does a financial analyst do?</h3>
                <p className="text-xs text-slate-500">Financial analysts analyze financial data, create budgets, forecast future performance, prepare reports, and provide insights to help businesses make strategic decisions.</p>
              </div>
              <div>
                <h3 className="text-sm font-semibold text-[#0A2540] mb-1">How much do financial analyst interns earn in India?</h3>
                <p className="text-xs text-slate-500">Financial analyst interns typically earn between Rs.15,000 to Rs.40,000 per month depending on the company and location.</p>
              </div>
              <div>
                <h3 className="text-sm font-semibold text-[#0A2540] mb-1">What skills are needed for financial analyst internships?</h3>
                <p className="text-xs text-slate-500">Excel, financial modeling, data analysis, accounting knowledge, budgeting, forecasting, and strong analytical thinking.</p>
              </div>
              <div>
                <h3 className="text-sm font-semibold text-[#0A2540] mb-1">Which companies hire financial analyst interns?</h3>
                <p className="text-xs text-slate-500">Top companies include Deloitte, PwC, EY, KPMG, Accenture, Amazon, Microsoft, Google, and many other MNCs.</p>
              </div>
              <div>
                <h3 className="text-sm font-semibold text-[#0A2540] mb-1">Do financial analyst internships lead to full-time jobs?</h3>
                <p className="text-xs text-slate-500">Yes, many companies offer pre-placement offers (PPOs) to high-performing financial analyst interns.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#0A2540] rounded-xl p-8 text-center">
            <h3 className="text-white text-xl font-semibold mb-2">Ready to start your financial analyst career?</h3>

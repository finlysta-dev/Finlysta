...
const PostInternshipPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.companyLogo) {
        ...
        logoFormData.append('logo', formData.companyLogo);
      ...
      if (response.ok) {
        const token = result.posterToken || result.token || result.internshipId;
        setPosterToken(token);
        setInternshipTitle(formData.internshipTitle);
        
        if (token) {
          localStorage.setItem('lastPostedInternshipId', token);
        }
        
        setSubmitMessage({ 
          type: 'success', 
          text: '✅ Internship posted successfully! Your internship is now under review.' 
        });
        ...
        setSubmitMessage({ type: 'error', text: result.error || 'Failed to post internship. Please try again.' });
      }
    } catch (error) {
  ...
  const handleViewSuccessPage = () => {
    if (posterToken) {
      router.push(`/employers/internship-posted?token=${posterToken}`);
    } else {
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Internship Posted Successfully!</h2>
            <p className="text-gray-600 mb-4">
              Your internship "{internshipTitle}" has been submitted. Our team will review it within 5 minutes.
            </p>
            <div className="bg-blue-50 rounded-lg p-3 mb-4">
              <p className="text-sm text-blue-800">
                🔑 Your unique tracking link has been created. You can view your internship status anytime.
              </p>
            </div>
      ...
      <main className="max-w-[1100px] mx-auto px-6 py-8">
        <div className="flex gap-8 items-start">
          ...
          <div className="flex-1 min-w-0">
            <div className="mb-7">
              <h1 className="text-4xl font-extrabold text-gray-900 leading-tight">Post an Internship for Free</h1>
              <p className="text-lg text-gray-600 mt-2">
                Find motivated finance students and fresh graduates for internship roles.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <section className="bg-white rounded-xl border border-[#E2E8F0] p-6 shadow-sm">
                <SectionHeader num="2" title="Internship Details" sub="Details about the internship opportunity" />
                <div className="grid grid-cols-3 gap-5">

                  <div>
                    <label className={labelClass}>Internship Title <span className="text-red-500">*</span></label>
                    <input
                      type="text" name="internshipTitle" value={formData.internshipTitle}
                      onChange={handleInputChange} className={inputClass}
                  ...
                  <div>
                    ...
                    <SelectWrap>
                      <select name="hiringFor" value={formData.hiringFor}
                        ...
                        <option>Audit Intern</option>
                        <option>Tax Intern</option>
                        <option>Investment Banking Intern</option>
                        <option>Equity Research Intern</option>
                        <option>MIS Intern</option>
                  ...
                  <div>
                    <label className={labelClass}>Stipend <span className="text-red-500">*</span></label>
                    <input
                      type="text" name="stipend" value={formData.stipend}
                      onChange={handleInputChange} className={inputClass}
                      placeholder="e.g. ₹15,000/month" required
                    />
                  </div>
                ...
                <div className="mt-4 flex items-center gap-2">
                  ...
                  <label htmlFor="fresherSuitable" className="text-base text-gray-700">
                    This internship is suitable for freshers or students.
                  </label>
                </div>
              </section>
              ...
              <section className="bg-white rounded-xl border border-[#E2E8F0] p-6 shadow-sm">
                <SectionHeader num="3" title="Candidate Requirements" sub="Who can apply for this internship?" />
              ...
              {/* Section 4 - Internship Description */}
              <section className="bg-white rounded-xl border border-[#E2E8F0] p-6 shadow-sm">
                <SectionHeader num="4" title="Internship Description" sub="Provide complete details about the internship" />
                <div className="grid grid-cols-3 gap-5">
                ...
                <div className="mt-4">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange} rows={3} maxLength={300}
                    className={textareaClass} placeholder="Tell candidates what makes this internship great..."
                  />
                  <div className="text-right text-sm text-gray-500 mt-1">
                ...
                <div className="space-y-3 mb-6">
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      className="rounded border-gray-300 text-[#2563EB] w-4 h-4 flex-shrink-0"
                    />
                    <span className="text-base text-gray-700">I confirm this is a genuine internship opportunity.</span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
          ...
          <div className="w-[320px] flex-shrink-0 space-y-5 sticky top-[72px] self-start">
            ...
            <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-2xl p-5 text-white text-center">
              ...
              <p className="text-base text-white/80 leading-snug">Post Internships Completely Free During Our Launch Phase</p>
            </div>
            ...
            <div className="bg-white rounded-xl border border-[#E2E8F0] p-5">
              ...
              <ul className="space-y-2.5">
                <li className="flex items-start gap-2 text-sm text-gray-700"><Check size={16} className="text-green-500" /> Write a clear internship title</li>
                <li className="flex items-start gap-2 text-sm text-gray-700"><Check size={16} className="text-green-500" /> Add complete description</li>
                <li className="flex items-start gap-2 text-sm text-gray-700"><Check size={16} className="text-green-500" /> Mention stipend clearly</li>
                <li className="flex items-start gap-2 text-sm text-gray-700"><Check size={16} className="text-green-500" /> Highlight learning opportunities</li>
              </ul>
            </div>

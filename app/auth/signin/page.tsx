...
export default function SignInPage() {
  ...
  const words = ["Dream", "Internship", "Career", "Future"];
    ...
    <>
      <style suppressHydrationWarning>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .wf-legal .wf-signup-link {
          color: var(--primary);
          font-weight: 600;
          text-decoration: none;
        }
        .wf-legal .wf-signup-link:hover { text-decoration: underline; }
        ...
        .wf-success-icon svg { color: var(--primary); }
      ...
      <div className="wf-root">
        ...
        {success && (
          <div className="wf-success-overlay">
            <div className="wf-success-card">
              ...
              <Link href="/" className="wf-success-btn">
                Go to Dashboard →
              </Link>
        ...
        <nav className="wf-nav">
          ...
          <div className="wf-nav-right">
            ...
            <Link href="/auth/register" className="wf-nav-signup">Create account</Link>
          </div>
        </nav>
        ...
        <div className="wf-body">
          ...
          <div className="wf-left">
            ...
            <p className="wf-tagline">
              Sign in to continue your journey. Your next great internship opportunity is waiting for you.
            </p>
          ...
          <div className="wf-right">
            <div className="wf-card">
              <h2 className="wf-form-title">Welcome back</h2>
              <p className="wf-form-sub">Sign in to access your account</p>

              {/* Welcome Message */}
              <div className="wf-welcome-message">
                <p>
                  👋 Glad to see you again! <span>Sign in</span> to continue where you left off.
                </p>
              </div>
              ...
              <div className="wf-div">
                ...
                <span className="wf-div-txt">or sign in with email</span>
                <div className="wf-div-line" />
              </div>

              {/* Form */}
              <form onSubmit={handleSignIn} className="wf-form">
                <div>
                ...
                <div className="wf-forgot">
                  <Link href="/auth/forgot-password" className="wf-forgot-link">
                    Forgot password?
                  </Link>
                </div>
              ...
              <p className="wf-legal">
                ...
                <Link href="/auth/register" className="wf-signup-link">Create one</Link>
              </p>
            </div>
          </div>

    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center bg-white rounded-2xl p-8 max-w-md mx-4 shadow-lg border border-gray-100">
          ...
          <button 
            onClick={fetchJobs} 
            className="mt-6 px-6 py-2.5 bg-[#FFD700] text-gray-900 font-semibold rounded-lg hover:bg-[#FFA500] transition"
          >
            Try Again
          </button>
        </div>
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-2">
              {skillFilters.map((skill) => (
                <button
                  key={skill}
                  onClick={() => handleSkillFilterClick(skill)}
          ...
          {/* Explore More Finance Career Resources */}

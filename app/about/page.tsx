  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 py-14">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-gray-900 tracking-tight mb-6">
            About <span className="text-indigo-600">Finlysta</span>
          </h1>

          <p className="text-xl text-gray-600 leading-relaxed max-w-none">
            Finlysta is a modern internship discovery platform designed to bridge
     ...
     <section className="max-w-6xl mx-auto px-6 py-10 space-y-10">
        ...
        <div className="flex gap-4 items-start">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Finlysta isn't just a platform—it's a community of ambitious students, 
              mentors, and companies who believe in the power of internships. Connect with 
              peers, share experiences, and grow together.
            </p>
            <div className="flex gap-4">
              <a href="https://www.linkedin.com/company/join-Finlysta/" className="text-indigo-600 font-medium hover:text-indigo-800">Follow on LinkedIn →</a>
            </div>
          </div>
        </div>
        ...
        {/* CTA - REMOVED Create Account Button */}
        <div className="bg-indigo-600 text-white p-8 rounded-2xl text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to start your journey?</h2>
          <p className="text-indigo-100 mb-6 max-w-2xl mx-auto">
            Join thousands of students who've found their dream internships on Finlysta.
          </p>
